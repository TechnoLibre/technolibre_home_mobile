            ...
            },
            {
                ...
                howItWorks: {
                    en: "Default mosaic grid (3-6 columns by viewport "
                        ...
                        + "one-finger pan once zoomed, and double-tap to "
                        + "toggle 1×↔2×. CSS sets touch-action: none on "
                        + "the viewer so the component owns every "
                        + "gesture; navigation between images resets "
                        + "the zoom. The image path goes through "
                    ...
                    fr: "Grille mosaïque par défaut (3-6 colonnes selon "
                        ...
                        + "4×, le pan à un doigt une fois zoomée, et le "
                        + "double-tap pour basculer 1×↔2×. CSS pose "
                        + "touch-action: none sur la visionneuse pour "
                        + "que le composant capte tous les gestes; "
                        + "naviguer entre images réinitialise le zoom. "
                        + "Le path image passe par "
